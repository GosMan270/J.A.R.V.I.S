...
class CommandMappings:
    def command_map(self):
        COMMAND_MAPPINGS = [
            {
                "examples": [
                    "Отдай мне мой план тренировок", "Напомни мой план тренировок", "Что с моими тренировками",
                    "Что с тренировками на сегодня", "Какой у меня план тренировок на сегодня", "Мне нужен план тренировок"
                ],
                "function": "MyCoach"
            }
        ]
